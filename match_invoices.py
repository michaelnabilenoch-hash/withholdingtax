...
st.markdown("---")
st.caption("تم التطوير بواسطة واحد عارف إن مطابقة خصم المنبع في مصر = حرب.. وانتصر فيها") قولى اذاى ارفعة على النت انا عندى مساحدة خاصة بى
